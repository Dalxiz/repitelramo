...
<head>
    ...
    function validarCampos(){
        ...
        var accion = document.getElementById("btnAccion").value;
      ...
      <div class="modal-body">
        <div class="col-lg-12">
            <form action="../../controlador/controladorProducto.php" id="formProd" method="POST">
                ...
                <div class="form-group"> 
                <button id="btnAccion" type="submit" name="actualizar" class="btn btn-primary" onclick="return validarCampos()">Guardar</button>
                </div>
            </form>
       </div>
      </div>
