<form action="../../../controlador/controladorEncabezadoDocumento.php" id="formProd" method="POST">            
                    <div class="container-fluid">
                            ...
                            <div class="container-fluid bg-light pb-1">
                                <div class="form-group row ">
                                    <div class="col-7">
                                        ...
                                        <select onchange="cargaPrecioUnitYUM('info')"  class="form-control" name="producto" id="cbxProducto">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-offset-1">
                                        ...
                                        <div class="text-center">
                                            <button onclick="agregarProd('info')" type="button" class="btn btn-success" id="btnAgregar" name="btnAgregar"><i class="bi bi-plus-circle-fill"></i></button>                 
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="container-fluid table-responsive bg-light">  
                                <table id="tablaProd" class="table is-striped table-hover " style="width:100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            <button type="button" onclick="eliminarProd(this, '#modalFactInfo')" class="btn btn-danger"><span class="bi bi-dash-circle-fill"></span></button>
                        ...
                        <div class="container-fluid mt-4">
                            <div class="form-group">
                                <button class="btn btn-dark col-lg-12" id="btnAccion" name="actualizar" onclick="return validarCampos('info')" type="submit">Actualizar</button>
                            </div>
                        </div>                        
                    </form>